...
addScrollBar('percentageHeal', 'Percentage to heal', 1, 100, 99, tabName, '%');
addScrollBar('delayHeal', 'Delay Healing', 1, 120, 1, tabName, 'Seconds');
addScrollBar('distanceHeal', 'Distance to Heal', 1, 10, 1, tabName, '');
